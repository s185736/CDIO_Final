    ...
    private Felt[] opretFelter() {
        return new Felt[] {
                ...
                * ÆNDRING AF FELTER FOREGÅR BÅDE I Spillerplade.java samt dansk.txt*/
                ...
                new Hus(Oversaetter.t("spilleplade.felt.hvidovrevej.beskrivelse"), 1, Color.WHITE).setUnderBeskrivelse("kr. 1.200"),
                ...
                new Hus(Oversaetter.t("spilleplade.felt.frederiksbergalle.beskrivelse"), 1, Color.GREEN).setUnderBeskrivelse("kr. 2.800"),
                new Hus(Oversaetter.t("spilleplade.felt.tuborgsquash.beskrivelse"), 1, Color.WHITE).setUnderBeskrivelse("kr. 3.000"),
                new Hus(Oversaetter.t("spilleplade.felt.bulowsvej.beskrivelse"), 1, Color.GREEN).setUnderBeskrivelse("kr. 2.800"),
                new Hus(Oversaetter.t("spilleplade.felt.glkongevej.beskrivelse"), 1, Color.GREEN).setUnderBeskrivelse("kr. 3.200"),
                new Rederi(true).setUnderBeskrivelse("Scandlines"),
                ...
                new Hus(Oversaetter.t("spilleplade.felt.cocacola.beskrivelse"), 1, Color.WHITE).setUnderBeskrivelse("kr. 3.000"),
                ...
                new Rederi(true).setUnderBeskrivelse("Scandlines"),
                new Chancekort().setFeltNavn("Prøv-Lykken").setUnderBeskrivelse("?"),
                new Hus(Oversaetter.t("spilleplade.felt.frederiksgade.beskrivelse"), 1, Color.PINK).setUnderBeskrivelse("kr. 7.000"),
                new StatsSkat(true).setUnderBeskrivelse("Statsskat"),
                new Hus(Oversaetter.t("spilleplade.felt.raadhuspladsen.beskrivelse"), 1, Color.PINK).setUnderBeskrivelse("kr. 8.000"),
        };
    }
}