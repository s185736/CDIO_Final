...
public class Felter {
    ...
    public static Felt[] getFelter(){
        ...
        nyFelt[5] = new Rederi(Oversaetter.t("spilleplade.felt.scandlines1.beskrivelse"), 4000, 500, Color.white).setUnderBeskrivelse("Scandlines");
        ...
        nyFelt[15] = new Rederi(Oversaetter.t("spilleplade.felt.molslinien.beskrivelse"), 4000, 500, Color.white).setUnderBeskrivelse("Mols-Linien");
        ...
        nyFelt[20] = new Parkering().setFeltNavn("Parkering").setUnderBeskrivelse("Gratis Parkering");
        ...
        nyFelt[22] = new Chancekort().setFeltNavn("Prøv-Lykken").setUnderBeskrivelse("Prøv-Lykken");
        ...
        nyFelt[25] = new Rederi(Oversaetter.t("spilleplade.felt.scandlines2.beskrivelse"), 4000, 500, Color.white).setUnderBeskrivelse("Scandlines");
        ...
        nyFelt[33] = new Chancekort().setFeltNavn("Prøv-Lykken").setUnderBeskrivelse("Prøv-Lykken");
        ...
        nyFelt[35] = new Rederi(Oversaetter.t("spilleplade.felt.scandlines3.beskrivelse"), 4000, 500, Color.white).setUnderBeskrivelse("Scandlines");
