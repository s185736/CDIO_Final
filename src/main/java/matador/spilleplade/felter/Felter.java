...
public class Felter {
    ...
    public static Felt[] getFelter(){
        ...
        nyFelt[5] = new Rederi(Oversaetter.t("spilleplade.felt.scandlines1.beskrivelse"), 4000, 600, Color.white).setUnderBeskrivelse("Scandlines");
        ...
        nyFelt[15] = new Rederi(Oversaetter.t("spilleplade.felt.molslinien.beskrivelse"), 4000, 600, Color.white).setUnderBeskrivelse("Mols-Linien");
        ...
        nyFelt[25] = new Rederi(Oversaetter.t("spilleplade.felt.scandlines2.beskrivelse"), 4000, 600, Color.white).setUnderBeskrivelse("Scandlines");
        ...
        nyFelt[35] = new Rederi(Oversaetter.t("spilleplade.felt.scandlines3.beskrivelse"), 4000, 600, Color.white).setUnderBeskrivelse("Scandlines");
